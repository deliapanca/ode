...
The section introduced the general method of solving equations with separable variables, presented in the classic differential equations books mentioned in the bibliography. The owner's contribution were the selection and solving of the examples.
...
\subsection{Conclusions}
The section introduced the notion of linear differential equation of first order and two methods of solving it, including the one used in practice, from the classic differential equations books mentioned in the bibliography. The owner's contribution was the selection and solving of the examples. 
